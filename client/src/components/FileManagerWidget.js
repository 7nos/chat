...
import { getUserFiles, renameUserFile, deleteUserFile, getFileContentUrl } from '../services/api';
...
const FileManagerWidget = ({ refreshTrigger }) => {
  ...
  const handleDownloadFile = (file) => {
    const url = getFileContentUrl(file.relativePath);
                ...
                {renamingFile !== file.serverFilename && (
                  <div className="fm-file-actions">
                    <button
                        ...
                        className="fm-action-btn fm-view-btn"
                        title="View"
                    >
                        👁️
                    </button>
                    <button
                        ...
                        disabled={isLoading || !!renamingFile}
                        className="fm-action-btn fm-download-btn"
                        title="Download"
                    >
                        ⬇️
                    </button>
